...
let famAndFriends = ["Mom", "Dad", "Manu", "Hardik", "Omi"]
let sortedCollection1 = famAndFriends.sorted{forwards(name1: $0, name2: $1)}
...
let sortedCollection2 = famAndFriends.sorted{name1, name2 in name1 < name2}
...
let sortedCollection3 = famAndFriends.sorted{$0<$1}
